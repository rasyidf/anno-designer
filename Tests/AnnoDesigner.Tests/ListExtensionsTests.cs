...
namespace AnnoDesigner.Tests
{
    public class ListExtensionsTests
    {
        ...
        {
            // Arrange/Act
            List<LayoutObject> result = ListExtensions.WithoutIgnoredObjects(null);
        ...
        {
            // Arrange/Act
            List<LayoutObject> result = ListExtensions.WithoutIgnoredObjects([]);
        ...
        public void WithoutIgnoredObjects_ListHasNoIgnorableObjects_ShouldReturnSameList()
        {
            ...
            // Act
            List<LayoutObject> result = ListExtensions.WithoutIgnoredObjects(list);
