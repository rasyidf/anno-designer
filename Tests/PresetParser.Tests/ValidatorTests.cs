...
namespace PresetParser.Tests
{
    public class ValidatorTests
    {
        ...
        {
            // Arrange/Act
            var (isValid, duplicateIdentifiers) = _validator.CheckForUniqueIdentifiers(_testData_valid_buildingInfo, null);
        ...
        {
            // Arrange/Act
            var (isValid, duplicateIdentifiers) = _validator.CheckForUniqueIdentifiers(_testData_valid_buildingInfo, []);
        ...
        {
            // Arrange/Act
            var (isValid, duplicateIdentifiers) = _validator.CheckForUniqueIdentifiers(_testData_invalid_buildingInfo, []);
        ...
        public void CheckForUniqueIdentifiers_DuplicateIdentifiersAndKnownDuplicates_ShouldReturnNotValidAndListOfIdentifiers()
        {
            ...
            // Arrange
            var (isValid, duplicateIdentifiers) = _validator.CheckForUniqueIdentifiers(_testData_invalid_buildingInfo, [knownDuplicate]);
        ...
        public void CheckForUniqueIdentifiers_KnownDuplicatesFound_ShouldReturnIsValid()
        {
            ...
            // Act
            var (isValid, duplicateIdentifiers) = _validator.CheckForUniqueIdentifiers(_testData_valid_buildingInfo, [knownDuplicate]);
